            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
              ...
              <div className="mt-8 flex justify-center">
                <button
                  ...
                  className={`px-4 py-2 rounded-md ${userType === UserType.Student ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'}`}
                >
                  Student
                </button>
                <button
                  ...
                  className={`px-4 py-2 rounded-md ml-4 ${userType === UserType.Professor ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'}`}
                >
                  Professor
                </button>
              </div>
