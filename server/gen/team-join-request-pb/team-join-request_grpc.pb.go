...
type TeamJoinRequestServiceClient interface {
	...
	GetAllJoinRequests(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TeamJoinRequestList, error)
...
func (c *teamJoinRequestServiceClient) GetAllJoinRequests(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TeamJoinRequestList, error) {
...
type TeamJoinRequestServiceServer interface {
	...
	GetAllJoinRequests(context.Context, *Empty) (*TeamJoinRequestList, error)
...
func (UnimplementedTeamJoinRequestServiceServer) GetAllJoinRequests(context.Context, *Empty) (*TeamJoinRequestList, error) {
...
func _TeamJoinRequestService_GetAllJoinRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeamJoinRequestServiceServer).GetAllJoinRequests(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TeamJoinRequestService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "team-join-request.proto",
}
